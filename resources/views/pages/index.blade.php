    ...
    <flux:main>
        ...
        >
            <div
                ...
                class="relative w-3xl max-w-full flex-col overflow-hidden rounded-lg bg-[#0C182D] shadow-md shadow-slate-300 transition-transform duration-700 ease-in-out dark:shadow-slate-800"
                :class="{
        ...
        <div class="group mt-36 mb-10 text-center text-sm tracking-wide opacity-90 *:transition-colors">
            <a
